...
public class HtmlCssVideoListAdapter extends RecyclerView.Adapter<HtmlCssVideoListAdapter.InnerHolder> {
    ...
    @Override
    public void onBindViewHolder(HtmlCssVideoListAdapter.InnerHolder holder, int position) {
        //设置数据
        ...
        Glide.with(holder.itemView.getContext()).load(video.getImgsrc()).into(holder.mVideoCoverImg);

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO: 2020/3/6 0006 视频item点击事件
            }
        });
    }

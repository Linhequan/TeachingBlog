...
public class LinuxArticleListAdapter extends RecyclerView.Adapter<LinuxArticleListAdapter.InnerHolder> {
    ...
    @Override
    public LinuxArticleListAdapter.InnerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_article, parent, false);
        return new InnerHolder(itemView);
    }

    @Override
    public void onBindViewHolder(LinuxArticleListAdapter.InnerHolder holder, int position) {
        //设置数据
        ...
        holder.mArticleAddTimeTv.setText(article.getAddtime());
